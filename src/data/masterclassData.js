...
export const masterclassTestimonialsData = {
  ...
  items: [
    ...
    },
    {
      ...
      video: '/testimonials/mr_aakash_maid.mp4', // Update with actual video path
      gradientFrom: '#F97316',
      gradientTo: '#EA6C0A',
    },
    {
...
/* ── Text Only Testimonials (No Videos) ────────────────── */
export const textTestimonialsData = {
